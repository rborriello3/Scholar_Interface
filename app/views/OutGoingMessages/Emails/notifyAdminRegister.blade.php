...
<p>Please be advised that without your permission the user will not be able to login. The steps that must be taken are
    as follows:</p>
<ul>
    <li>Assign the user a role</li>
    <li>Activate the users account</li>
    <li>Assign the user a ending aid year</li>
</ul>

<p>Once you have completed the above the user will recieve an email notificaiton with a temporary password and
    instructions for
