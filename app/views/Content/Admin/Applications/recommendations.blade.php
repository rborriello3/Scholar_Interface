...
<div id="recommendations">
    ...
    @if ($one || $two)
    &nbsp;&nbsp;&nbsp;{{ Form::button('Reload Data', array('class' => 'btn btn-primary', 'onClick' =>
        ...
        <div class="recomm panel panel-primary">
            ...
            <ul class="panel-body">
                <li>
                    ...
                    <br>
                    {{ Form::text('recommender1', $recommendation->recommender1, array('placeholder' => 'Recommender',
                    'autocomplete' => 'off')) }}
                </li>
                ...
                <li>
                    ...
                    <br>
                    {{ Form::text('email1', $recommendation->email1, array('placeholder' => 'Email', 'autocomplete' =>
                    'off')) }}
                </li>
                ...
                <li>
                    ...
                    <br>
                    {{ Form::text('department1', $recommendation->department1, array('placeholder' => 'Department',
                    'autocomplete' => 'off')) }}
                </li>
                ...
                <li>
                    ...
                    <br>
                    {{ Form::text('courseName1', $recommendation->courseName1, array('placeholder' => 'Course Name(s)',
                    'autocomplete' => 'off')) }}
                </li>
            </ul>
        </div>
        ...
        <div class="recomm1Info panel panel-primary">
            ...
            <ul>
                ...
                <li>
                    ...
                    <br>
                    {{ Form::text('comments1', $recommendation->comments1, array('placeholder' => 'Comments',
                    'autocomplete' => 'off')) }}
                </li>
            </ul>
        </div>
        ...
        <div class="recomm panel panel-primary">
            ...
            <ul class="panel-body">
                <li>
                    ...
                    <br>
                    {{ Form::text('recommender2', $recommendation->recommender2, array('placeholder' => 'Recommender',
                    'autocomplete' => 'off')) }}
                </li>
                ...
                <li>
                    ...
                    <br>
                    {{ Form::text('email2', $recommendation->email2, array('placeholder' => 'Email', 'autocomplete' =>
                    'off')) }}
                </li>
                ...
                <li>
                    ...
                    <br>
                    {{ Form::text('department2', $recommendation->department2, array('placeholder' => 'Department',
                    'autocomplete' => 'off')) }}
                </li>
                ...
                <li>
                    ...
                    <br>
                    {{ Form::text('courseName2', $recommendation->courseName2, array('placeholder' => 'Course Name(s)',
                    'autocomplete' => 'off')) }}
                </li>
            </ul>
        </div>
        ...
        <div class="recomm1Info panel panel-primary">
            ...
            <ul>
                ...
                <li>
                    ...
                    <br>
                    {{ Form::text('comments2', $recommendation->comments2, array('placeholder' => 'Comments',
                    'autocomplete' => 'off')) }}
                </li>
            </ul>
        </div>
