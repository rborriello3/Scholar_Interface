...
@section('head')
	<title>Scholarship Interface New Student</title>
@parent
...
@section('dashBoardContent')
	...
	{{ Form::open(array('url' => route('doNewStudent', array()), 'method' => 'POST', 'accept-charset' => 'UTF-8')) }}
		<br>{{ Form::submit('Create Student', array('class' => 'btn btn-success'))}} &nbsp; {{link_to_route('showStudentHome', 'Cancel Update')}}<br><br>
		...
		<div id="generalInfo" class="panel panel-primary">
	        ...
	        <ul>
		        <li>
		        	...
		        	{{Form::text('studentID','', array('maxlength' => 9, 'size' => '8'))}}
		        </li>
		        <li>
		...
		<div id="contact" class="panel panel-primary">
			...
			<ul>
				<li>
					...
					{{Form::text('personalEmail','' , array('size' => '40'))}}
				</li>
				<li>
					{{form::label('sunyEmail', 'Official Email:')}}<br>
					{{Form::text('sunyEmail','' , array('size' => '40'))}}
				</li>
				<li>
					{{Form::label('homephone', 'Home Phone:')}}<br>
					{{Form::text('homephone','' , array('maxlength' => 10, 'size' => '9'))}}
				</li>
				<li>
					{{Form::label('cellPhone', 'Cell Phone:')}}<br>
					{{Form::text('cellPhone','' , array('maxlength' => 10, 'size' => '9'))}}
				</li>
				<li>
					{{Form::label('cellCarrier', 'Cell Carrier:')}}<br>
					{{Form::select('cellCarrier', $carrier)}}
				</li>
			</ul>
		</div>
		...
		<div id="address" class="panel panel-primary">
			...
			<ul>
				...
				<li>
					...
					{{Form::text('zipCode','' , array('size' => '3', 'maxlength' => '5'))}}
				</li>
				<li>
					{{Form::label('county', 'County:')}}<br>
					{{Form::text('county','' , array('size' => '15'))}}
				</li>
			</ul>			
		</div>
		...
		<div id="demograph1" class="panel panel-primary">
			...
			<ul>
				...
				<li>
					...
					{{Form::text('creditHourSP','' , array('size' => '2', 'placeholder' => '##.##'))}}
				</li>

				<li>
					{{Form::label('creditHourFA', 'Fall Credits:')}}<br>
					{{Form::text('creditHourFA','' , array('size' => '2', 'placeholder' => '##.##'))}}
				</li>

				<li>
					{{Form::label('creditsEarned', 'Earned Credits:')}}<br>
					{{Form::text('creditsEarned','' , array('size' => '2', 'placeholder' => '##.##'))}}
				</li>
				<li>
					{{Form::label('GPA', 'GPA:')}}<br>
					{{Form::text('GPA','' , array('size' => '1', 'placeholder' => '#.##'))}}
				</li>
				<li>
					{{Form::label('collegeGrad', 'College Graduation:')}}<br>
					{{Form::text('collegeGrad','' , array('size' => '4', 'placeholder' => 'MM/YY'))}}
				</li>
			</ul>
		</div>
		...
		<div id="demograph2" class="panel panel-primary">
			...
			<ul>	
				<li>
					...
					{{Form::text('highSchoolName','' , array('size' => '50'))}}
				</li>
				<li>
					{{Form::label('highSchoolAvg', 'High School Avg:')}}<br>
					{{Form::text('highSchoolAvg','' , array('size' => '3', 'placeholder' => '##.##'))}}
				</li>

				<li>
					{{Form::label('highGrad', 'High School Graduation:')}}<br>
					{{Form::text('highGrad','' , array('size' => '4', 'placeholder' => 'MM/YY'))}}
				</li>
			</ul>
		</div>
		...
		<div id="demograph3" class="panel panel-primary">
			...
			<ul>
				<li>
					...
					{{Form::text('transferMaj','' , array('size' => '65'))}}
				</li>

				<li>
					{{Form::label('transferInsti', 'Transfering Institute:')}}<br>
					{{Form::text('transferInsti','' , array('size' => '65'))}}
				</li>
			</ul>
		</div>

		<br>{{ Form::submit('Create Student', array('class' => 'btn btn-success'))}}<br><br>
	{{ Form::close()}}
@stop
