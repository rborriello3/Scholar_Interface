...
@section('head')
<title>Scholarship Interface Graduating Addressess</title>
@parent
...
<br>
    <h4 class='reportName'>Graduating Student Address</h4>
    {{ Datatable::table()
    ->setURL(route('graduatingStudentsRegret'))
    ->addColumn('Student ID', 'First', 'Last', 'Address 1', 'Address 2', 'City', 'State', 'Zip')
