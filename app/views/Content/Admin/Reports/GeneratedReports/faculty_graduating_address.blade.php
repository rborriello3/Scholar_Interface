...
@section('head')
<title>Scholarship Interface Faculty Graduating Students</title>
@parent
...
<br>
    <h4 class='reportName'>All Awarded Graduating Faculty Recommended Students</h4>
    {{ Datatable::table()
    ->setURL(route('facultyGraduatingAddress'))
