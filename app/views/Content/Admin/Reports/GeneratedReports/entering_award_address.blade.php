...
<br>
    <h4 class='reportName'>All Awarded Entering Students</h4>
    {{ Datatable::table()
    ->setURL(route('getAllEnteringAwardAddress'))
    ->addColumn('Student ID', 'First', 'Last', 'Email', 'Address 1', 'Address 2', 'City', 'State', 'Zip','HS', 'Scholarship', 'Amount')
