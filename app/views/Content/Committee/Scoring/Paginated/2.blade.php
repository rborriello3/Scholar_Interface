...
{{ Form::radio('massGradeType', 2)}} <strong>Entering</strong>({{'<font color="green">' .
    $applicationCounts['enteringGraded'] . '</font> / <font color="red">'. $applicationCounts['entering'] .
    '</font>'}}) &nbsp;
...
<div id="information">
    ...
    <div id="educationalInfo" class="panel panel-primary">
        ...
        <ul class="panel-body">
            <li>
                High School:
                <b>{{{$scoringInfo['education']['highSchoolName']}}}</b>
            </li>

            <li>
                High School Graduation:
                <b>{{{$scoringInfo['education']['highGrad']}}}</b>
            </li>

            <li>
                Diploma Type:
                <b>{{{$scoringInfo['education']['diploma']}}}</b>
            </li>
