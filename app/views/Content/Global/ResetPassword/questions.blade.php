...
@section('content')
<div id="questions">
    {{ Form::open(array('route' => 'password.reset.doQuestions', 'method' => 'POST', 'accept-charset' => 'UTF-8', 'id'
    => 'myForm')) }}
...
<div id="verifyAnswer">
    ...
    {{ Form::submit('Verify Answers', array('class' => 'btn btn-primary')) }} {{ link_to_route('password.EmailStep',
    'Return')}} or go to the {{ link_to_route('home.index', 'Home Page')}}
</div>
