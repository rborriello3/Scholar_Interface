...
<div id="activateForm">
    {{ Form::open(array('route' => array('doDeactivateUser', $userID), 'method' => 'POST', 'accept-charset' => 'UTF-8',
    'id' => 'myForm')) }}
    ...
    {{ Form::submit('Deactivate User', array('class' => 'btn btn-primary'))}} &nbsp;&nbsp;{{ link_to_route('showUsers',
    'Cancel') }}
    {{ Form::close() }}
</div>
